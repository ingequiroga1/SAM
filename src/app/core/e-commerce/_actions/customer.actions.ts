...
export enum CustomerActionTypes {
  ...
  CustomerNextNumberLoaded = '[Customers] Customers Action load Loading',
  CustomerNextNumberRequested = '[Customers] Customers Action get Loading'
}
...
export class CustomerNextNumberLoaded implements Action {
  readonly type = CustomerActionTypes.CustomerNextNumberLoaded;
  constructor(public payload: { nextId: string }) { }
}

export class CustomerNextNumberRequested implements Action {
  readonly type = CustomerActionTypes.CustomerNextNumberRequested;
}
