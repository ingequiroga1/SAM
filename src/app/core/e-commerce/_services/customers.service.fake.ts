...
export class CustomersService {
  ...
  createCustomer(customer: CustomerModel): Observable<CustomerModel> {
    ...
    return this.http.post<CustomerModel>("https://movencosamtest-movencoapi.azurewebsites.net/api/Client", customer, {headers: httpHeaders});
  }
  ...
  getNextCustomerNumber(): Observable<string> {
    ...
    return this.http.get<string>("https://movencosamtest-movencoapi.azurewebsites.net/api/Client/ClientNumber");
  }
  ...
  findCustomers(queryParams: QueryParamsModel): Observable<QueryResultsModel> {
    ...
    const url = "https://movencosamtest-movencoapi.azurewebsites.net/api/Client";
    return this.http.get<CustomerModel[]>("https://movencosamtest-movencoapi.azurewebsites.net/api/Client").pipe(
      mergeMap(res => {
