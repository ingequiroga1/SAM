...
export class ClientListComponent implements OnInit, OnDestroy,AfterViewChecked {
  // Table fields
  ...
  ngAfterViewChecked() {
    this.toolbarService.emit({ isShowRightToolbar: true, rightToolbarLinks:{ nuevoUrl :'/clients/add'} , parent:{name:'Community info',url:'/community'}, children:[ {name:'Clientes', url:'/clients/details'}]});
  }
